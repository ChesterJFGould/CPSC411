...
lower (Program blocks body) = P.Program (lowerBody body ++ concat (map lowerBlock blocks))
...
lowerTail (If (RelOp op a b) tLabel fLabel) = [ P.Compare a b
                                              , P.JumpIf op tLabel
                                              , P.Jump (RLabel fLabel) ]
